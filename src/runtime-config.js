...
export function normalizeRuntimeConfig(baseConfig = {}, overrides = {}) {
    ...
    const profileDir = String(overrides.profile_dir ?? baseConfig.profile_dir ?? '.profiles/duolingo-chromium').trim();
    ...
    const password = String(overrides.password ?? baseConfig.password ?? '').trim();
